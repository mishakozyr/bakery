...
class IntroSlider {
     ...
     * @param {String} prefix
     */
    constructor(el, config = {}, prefix = 'intro_slider__') {
  
      this.#state = {
        prefix: prefix, // префикс для классов
        el: el, // элемент который нужно активировать как IntroSlider
    ...
    /**
     * Статический метод, который возвращает экземпляр IntroSlider, связанный с DOM-элементом
     ...
     * @param {String} prefix
     */
    static getOrCreateInstance(target, config = {}, prefix = 'intro_slider__') {
      try {
    ...
    // статический метод для активирования элементов как IntroSlider на основе data-атрибутов
    static createInstances() {
      document.querySelectorAll('[data-slider="intro_slider"]').forEach((el) => {
    ...
    #attachEvents() {
      this.#state.events = {
        ...
        'intro_slider__transition-start': [this.#state.elItems, this.#onTransitionStart.bind(this), this.#config.loop],
    ...
    #move() {
      ...
      this.#state.elItems.dispatchEvent(new CustomEvent('intro_slider__transition-start', {
        bubbles: true
      }));
    }
