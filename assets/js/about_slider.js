...
class AboutSlider {
     ...
     * @param {String} prefix
     */
    constructor(el, config = {}, prefix = 'about_slider__') {
  
      this.#state = {
        prefix: prefix, // префикс для классов
        el: el, // элемент который нужно активировать как AboutSlider
    ...
    /**
     * Статический метод, который возвращает экземпляр AboutSlider, связанный с DOM-элементом
     ...
     * @param {String} prefix
     */
    static getOrCreateInstance(target, config = {}, prefix = 'about_slider__') {
      try {
    ...
    // статический метод для активирования элементов как AboutSlider на основе data-атрибутов
    static createInstances() {
      document.querySelectorAll('[data-slider="about_slider"]').forEach((el) => {
    ...
    #attachEvents() {
      this.#state.events = {
        ...
        'about_slider__transition-start': [this.#state.elItems, this.#onTransitionStart.bind(this), this.#config.loop],
    ...
    #move() {
      ...
      this.#state.elItems.dispatchEvent(new CustomEvent('about_slider__transition-start', {
        bubbles: true
      }));
    }
